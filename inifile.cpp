...
//				_T("File I/O error"), wxOK | wxICON_INFORMATION, NULL);
		...
		for ( s = file.GetFirstLine(); !file.Eof(); s = file.GetNextLine() )
		{
			...
			{
// Debug
//				wxMessageBox(_T("String match"), _T("IniFile::ReadIniStringFromFile"), wxOK | wxICON_INFORMATION, NULL);
...
// Debug
//	wxMessageBox(_T("Key not found"), _T("IniFile::ReadIniStringFromFile"), wxOK | wxICON_INFORMATION, NULL);
